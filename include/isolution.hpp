...
class ISolution {
    public:
        ...
        virtual std::string get_buildings_in_view(double sw_lat, double sw_lon, double ne_lat, double ne_lon) = 0;
        virtual std::string get_nearest_building(double lat, double lon) = 0;
